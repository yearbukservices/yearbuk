    ...
    <>
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 relative overflow-hidden">
          ...
          {showNotifications && user && (
            <div className="notification-dropdown fixed top-16 right-16 w-72 sm:w-80 max-w-[calc(100vw-2rem)] bg-blue-950/95 backdrop-blur-lg shadow-xl border border-white/20 z-[999999] rounded-lg">
